...
import com.example.api.exception.model.ApiError;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ApiError> unavailableExceptionunavailableException(RuntimeException ex) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
    ...
    @ExceptionHandler(MethodArgumentNotValidException.class) // Essa exceção é lançada quando as validações com o @NotNull, @NotEmpy, etc.. Falha.
